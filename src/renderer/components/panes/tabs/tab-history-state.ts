import { FileSystemItem, FsItems } from "@domain";
...
export class TabHistoryState {
  ...
  public remember(fsItems: FsItems) {
    ...
    if (fsItems.selected.length == 1) this.selectedFileSystemItem = fsItems.selected[0];
    else this.selectedFileSystemItem = undefined;
  }
